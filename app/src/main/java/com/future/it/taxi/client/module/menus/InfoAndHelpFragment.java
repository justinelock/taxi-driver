...
public class InfoAndHelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_menu_info_help, container, false);
        setHasOptionsMenu(false);
        getActivity().setTitle("Info and Help");
        ButterKnife.bind(this, rootView);
        return rootView;
    }

    @OnClick(R.id.cardHelp)
    public void onClick() {
        Fragment fragment = new HelpFragment();
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container, fragment).addToBackStack("help").commit();
    }
