...
public class VehicleLicenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_menu_vehicle_license, container, false);
        setHasOptionsMenu(false);
        getActivity().setTitle("Vehicle License");
